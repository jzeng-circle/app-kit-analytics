...
`report.md` — main report covering fee adoption, fee tier distribution, and Circle fee collections across testnet and mainnet for Swap Kit and Bridge Kit, with within-product analysis for each.
