...
| Repo | Link | ★ | Forks | Last Commit | What It Builds | Contact |
|---|---|---|---|---|---|---|
| Maje53/arc-payment-hub | https://github.com/Maje53/arc-payment-hub | 3 | 1 | 2026-04-11 | USDC bridge + send, uses x402-batching | [@0xMaje](https://twitter.com/0xMaje) |
...
| developermynk/Arc-Wallet | https://github.com/developermynk/Arc-Wallet | 0 | 0 | 2026-04-05 | Arc wallet app | developermynk@gmail.com · [@mayankkz_](https://twitter.com/mayankkz_) |
| mrrobot792/lumina | https://github.com/mrrobot792/lumina | 0 | 0 | 2026-04-13 | DEX reference implementation | — |
| starlash7/Arc-test | https://github.com/starlash7/Arc-test | 0 | 1 | 2026-04-06 | ERC-8183 escrow + App Kit playground | [@Pixy7Crypto](https://twitter.com/Pixy7Crypto) |
...
| mjkid221/fff-cctp-bridge | https://github.com/mjkid221/fff-cctp-bridge | 1 | 0 | 2026-04-11 | No-fee CCTP v2 bridge, EVM + Solana | jamerytstudio@gmail.com · [@mjkid0](https://twitter.com/mjkid0) |
...
| Emperoar07/Presto | https://github.com/Emperoar07/Presto | 0 | 0 | 2026-04-10 | Full DEX: AMM + bridge + deploy + analytics | [@emperoar007](https://twitter.com/emperoar007) |
| Kewe63/arc-network-dex | https://github.com/Kewe63/arc-network-dex | 0 | 1 | 2026-04-02 | USDC↔EURC FX DEX, Permit2, ERC-8004 | Discord: m.aliarslan |
...
| linux070/stac-defi | https://github.com/linux070/stac-defi | 0 | 0 | 2026-03-01 | Premium DeFi interface, bridge + swap | [@linux_mode](https://twitter.com/linux_mode) |
| EggsLeggs/usdc-hopper-hackathon | https://github.com/EggsLeggs/usdc-hopper-hackathon | 0 | 0 | 2025-12-10 | Minimalist bridge UI (hackathon) | [thinkhuman.dev](https://www.thinkhuman.dev) |
| aicarcwallet-arc/hackthone | https://github.com/aicarcwallet-arc/hackthone | 0 | 2 | 2025-11-08 | AI vocab game → earn tokens → bridge USDC | aicarcwallet@gmail.com |
...
#### 5. `bayrakdarerdem/freelance-arc` ★0
...
#### 7. `TS-mfon/sourcebounty-arc-genlayer` ★0
**Last commit**: 2026-04-13 | **Kits**: `app-kit`, `adapter-circle-wallets`, `adapter-ethers-v6`, `adapter-viem-v2` | **Structure**: Monorepo (`frontend/package.json`)
...
- Snapshot: `/Users/jiadong.zeng/circle-developer-kit-radar/docs/github-repos-snapshot.json`
